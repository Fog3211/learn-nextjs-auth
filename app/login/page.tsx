    ...
    <div className="flex items-center justify-center h-screen">
      <div className="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] ">
        ...
        <div className="mt-5 flex justify-center gap-3    ">
          ...
          <Link href='#' onClick={() => signIn('github', { callbackUrl })}>
            <img className="h-7 grayscale cursor-pointer hover:grayscale-0 scale-105 duration-300" src="https://authjs.dev/img/providers/github.svg" />
          </Link>
